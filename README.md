...
## Скриншот
Скриншот интерфейса: `docs/screenshot.png` (добавьте при демонстрации).

## Логи промптов
См. `docs/AI_LOG.md` — минимум 5 ключевых промптов с краткими ответами ИИ.

## Совместимость
- Chrome 120+ (обязательно)
- Firefox 120+, Safari 17+ (желательно)
